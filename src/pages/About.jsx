      ...
      <div className='container'>
        ...
        <div className='about-content grid'>
          ...
          <div className='about-text'>
            <h2 className='about-title fs-26 ls-1'>About Bookopia</h2>
            ...
            <p className='fs-17'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maxime, aliquid odio autem nemo ratione provident quod debitis dolorum, facere consectetur suscipit, nisi nam dicta voluptatum pariatur numquam vero modi ipsam?</p>
            <p className='fs-17'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Similique, amet vel voluptatem voluptas quo doloremque reprehenderit suscipit labore voluptates nisi fugit dolorum temporibus sint laborum, blanditiis quaerat, mollitia dignissimos esse?</p>
          </div>
        </div>
      </div>
    </section>
